    ...
    return (<div className="w-[40%] h-[200px] flex justify-center max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-0 items-center justify-center mt-4 space-x-3 md:mt-6">
                ...
                <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-center focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button>
            </div>
        </div>
